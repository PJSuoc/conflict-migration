...
# Most of this file is unused. A handful of functions are pulled to data_transform (re-used from the static project)
...
def json_maker_simple(df):
    ...
    for region, value in regions.items():
        country_subset = df[df["Region"] == region]
